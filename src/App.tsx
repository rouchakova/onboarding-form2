      ...
      case 'generic':
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <label className="block text-sm font-medium text-gray-700">
                1.b. What formats of advertising do you support in these environments?
              </label>
              <div className="grid grid-cols-2 gap-4">
                {[
                  'Display',
            ...
            {/* 1.c. Operation Type with additional note */}
            <div className="space-y-4">
              <label className="block text-sm font-medium text-gray-700">
                1.c. Do you own and operate (O&O) the inventory (or manufacture a device) that you intend to monetize through Sovrn?
                OR Act as an intermediary that handles or facilitates monetization on the owners behalf?
              </label>
              <select
            ...
            {/* 2.e. Supplemental Content Solutions */}
            <div className="space-y-4">
      ...
      case 'web':
        return (
          ...
          <div className="space-y-4">
            ...
            {/* 3.f Traffic Percentage by Region */}
            <div className="space-y-6">
              <label className="block text-sm font-medium text-gray-700">
            ...
            {/* 4.a Impression Tracking Methods */}
            <div className="space-y-4">
              <label className="block text-sm font-medium text-gray-700">
            ...
            {/* 4.c Ad-call Flow & Creative Rendering */}
            <div className="space-y-4">
      ...
      case 'ctvapp':
        return (
          ...
          <div className="space-y-4">
            ...
            {/* 5.f PMP Data and Sensitive Categories */}
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700">
            ...
            {/* 6.a Impression Tracking Methods */}
            <div className="space-y-4">
              <label className="block text-sm font-medium text-gray-700">
